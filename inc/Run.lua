...
redis:set(monster..":VERSION",2.9)
redis:set(monster..":SUDO_ID:",SUDO_USER)
redis:set(monster..":DataCenter:",'German')
redis:set(monster..":UserNameBot:",BOT_User)
redis:set(monster..":NameBot:",BOT_NAME)
redis:hset(monster..'username:'..SUDO_USER,'username','@'..GetUser.result.username:gsub('_',[[\_]]))
redis:set("TH3monster_INSTALL","Yes")
info = {}
...
if msg.type == "pv" and redis:get(monster..':mute_pv:'..msg.chat_id_) then
print('\27[1;31m is_MUTE_BY_FLOOD\27[0m')
return false 
end

if redis:get(monster..'sender:'..msg.sender_user_id_..':flood') then
...
msg.Rank = 2
elseif msg.GroupActive and redis:sismember(monster..':KARA_BOT:'..msg.chat_id_,msg.sender_user_id_) then 
...
if msg.Admin then redis:srem(monster..'is_silent_users:'..msg.chat_id_,msg.sender_user_id_) return end
...
if msg.Admin then redis:srem(monster..'banned:'..msg.chat_id_,msg.sender_user_id_) return end
...
for k, monster in pairs(ScriptFile.monster) do
local SearchText = msg.text:match(monster)
if SearchText then
if not CheckFlood(msg) then
return false 
end

local GetMsg = ScriptFile.imonster(msg,{msg.text:match(monster)})
if GetMsg then
...
Mohammad = msg.text
if Mohammad then
if redis:sismember(monster..'CmDlist:'..msg.chat_id_,Mohammad) then
mmdi = redis:hget(monster..'CmD:'..msg.chat_id_,Mohammad)
...
function tdcli_update_callback(data)
	...
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/inc/Run.lua','./inc/Run.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'40% - |█████       |')
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/inc/locks.lua','./inc/locks.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'60% - |███████     |')
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/inc/Script.lua','./inc/Script.lua')
	EditMsg(data.message_.chat_id_,data.message_.id_,'80% - |█████████   |')
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/inc/functions.lua','./inc/functions.lua')
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/plugins/zhrfa.lua','./plugins/zhrfa.lua')
	download_file('https://raw.githubusercontent.com/monsterTELLE/monster/master/plugins/games.lua','./plugins/games.lua')
...
msg.text = Mohammad:gsub(Mohammad,mmdi)
	...
	mmd = redis:get(monster..":SUDO_ID:")
redis:hset(monster..'username:'..tonumber(mmd),'username',msg.text)
	...
	redis:set(monster..":SUDO_ID:",msg.text)
...
download(stk,32)
	...
	if redis:get(monster..'group:add'..msg.chat_id_) and (msg.sender_user_id_ == SUDO_ID or redis:sismember(monster..':SUDO_BOT:',msg.sender_user_id_) or redis:sismember(monster..':MONSHA_BOT:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(monster..'owners:'..msg.chat_id_,msg.sender_user_id_) or redis:sismember(monster..'admins:'..msg.chat_id_,msg.sender_user_id_)) then 
	msg.Admin = true
	end
	local lock_bots = redis:get(monster..'lock_bots'..msg.chat_id_)
	ISBOT = false
	...
	if ZISBOT and redis:get(monster..'lock_bots_by_kick'..msg.chat_id_) then
	kick_user(msg.sender_user_id_, msg.chat_id_)
	end
...
if redis:get(monster..'lock:join:'..msg.chat_id_) then
kick_user(msg.sender_user_id_,msg.chat_id_)
