...
redis:set(monster.."getidstatus"..msg.chat_id_, "Simple")
...
redis:set(monster.."getidstatus"..msg.chat_id_, "Photo")
return  "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل الايدي بالصوره \n✓" 
end
function cmds_on(msg)
if not msg.Creator then return "📛*│* هذا الامر يخص {المنشئ,المطور} فقط  \n🚶"
end
redis:set(monster..'lock:kara:'..msg.chat_id_,'on')
return "🙋🏼‍♂️*╿* أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تعطيل الرفع في المجموعه \n✓"
end
function cmds_off(msg)
if not msg.Creator then return "📛*│* هذا الامر يخص {المنشئ,المطور} فقط  \n🚶"
end
redis:set(monster..'lock:kara:'..msg.chat_id_,'off')
...
redis:set(monster..'lock:join:'..msg.chat_id_,true)
...
redis:del(monster..'lock:join:'..msg.chat_id_)
...
Channel = redis:get(monster..'setch') or katrenno
--JoinChannel
function is_JoinChannel(msg)
if redis:get(monster..'joinchnl') then
...
local GroupName = (redis:get(monster..'group:name'..msg.chat_id_) or '')
redis:set(monster..'linkGroup'..msg.chat_id_,(data.invite_link_ or ""))
...
users = redis:get(monster..'user_names:'..v.user_id_) or v.user_id_
x = x + 1
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
local Chek_Info = https.request('https://api.telegram.org/bot'..Token..'/getChatMember?chat_id='.. msg.chat_id_ ..'&user_id='.. monster..'')
...
function(arg,data)
if data.ID == "Ok" then
redis:set(monster..":MsgIDPin:"..msg.chat_id_,msg.reply_id)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not MsgText[2] and msg.reply_id then
if redis:get(monster..'lock:kara:'..msg.chat_id_) == 'off' then
...
if redis:get(monster..'lock:kara:'..msg.chat_id_) == 'on' then
...
if not msg.Director then return "♦️*│*هذا الامر يخص {المطور,المنشئ,المدير} فقط  \n💥" end
redis:setex(monster..'linkGroup'..msg.sender_user_id_,300,true)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:setex(monster..'rulse:witting'..msg.sender_user_id_,300,true)
...
redis:set(monster..'flood'..msg.chat_id_,MsgText[2]) 
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
local NumMnsha = redis:scard(monster..':Hussain:'..msg.chat_id_)
if NumMnsha ==0 then 
return "♦️│عذرا لا يوجد منشى اساسي \n!" 
end
redis:del(monster..':Hussain:'..msg.chat_id_)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(monster..'name:witting'..msg.sender_user_id_,300,true)
...
if not msg.Creator then return "♦️*│*هذا الامر يخص {المطور,المنشئ} فقط  \n💥" end
redis:setex(monster..'about:witting'..msg.sender_user_id_,300,true) 
...
kick_user(v.user_id_,msg.chat_id_,function(arg,data)  
redis:srem(monster..':MONSHA_BOT:'..msg.chat_id_,v.user_id_)
redis:srem(monster..'whitelist:'..msg.chat_id_,v.user_id_)
redis:srem(monster..'owners:'..msg.chat_id_,v.user_id_)
redis:srem(monster..'admins:'..msg.chat_id_,v.user_id_)
end)
end
NumMem = NumMem + 1
...
local points = redis:get(monster..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
if points and points ~= "0" then
nko = points
else
nko = '0'
end
local rfih = (redis:get(monster..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if redis:get(monster.."getidstatus"..msg.chat_id_) == "Photo" then
...
redis:del(monster..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
...
local adduser = redis:get(monster..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0
if adduser == 0 then  return "⚠️*│*عذرا ليس لديك جهات لكي يتم مسحها" end
redis:del(monster..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) 
...
redis:del(monster..':User_Points:'..msg.chat_id_..msg.sender_user_id_)
...
GetUserID(msg.sender_user_id_,function(arg,data)
local msgs = (redis:del(monster..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_) or 0)
local NumGha = (redis:del(monster..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local photo = (redis:del(monster..':photo:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local sticker = (redis:del(monster..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local voice = (redis:del(monster..':voice:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local audio = (redis:del(monster..':audio:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local animation = (redis:del(monster..':animation:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local edited = (redis:del(monster..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
local video = (redis:del(monster..':video:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
redis:set(monster..'welcom:witting'..msg.sender_user_id_,true) 
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(monster..':NameBot:')..[[ ✓
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
return '🙍🏻‍♂*│*عدد المشتركين في البوت : `'..redis:scard(monster..'users')..'` \n📡'
end
...
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if redis:sismember(monster..'group:ids',MsgText[2]) then
local name_gp = redis:get(monster..'group:name'..MsgText[2])
...
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https.request('https://github.com/monsterTELLE/monster.github.io/GetVersion.txt') or 0
...
monster..'replay_animation:group:'..msg.chat_id_,monster..'replay_audio:group:'..msg.chat_id_,monster..'replay_sticker:group:'..msg.chat_id_,monster..'replay_video:group:'..msg.chat_id_)
...
if names or photo or voice or imation or audio or sticker or video then
redis:del(monster..'replay:all',monster..'replay_photo:group:',monster..'replay_voice:group:',monster..'replay_animation:group:',monster..'replay_audio:group:',monster..'replay_sticker:group:',monster..'replay_video:group:')
...
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if not redis:get(monster..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره بالتاكيد تم تفعيلها\n✓" 
else 
redis:del(monster..'lave_me'..msg.chat_id_) 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* تم تفعيل المغادره \n✓" 
end 
end
if MsgText[1] == "تعطيل" and MsgText[2] == "اطردني" then
if not msg.Admin then return "♦️*│*هذا الامر يخص {الادمن,المدير,المنشئ,المطور} فقط  \n💥" end
if redis:get(monster..'lave_me'..msg.chat_id_) then 
return "🙋🏻‍♂*╿*أهلا عزيزي "..msg.TheRankCmd.."\n📡*╽* المغادره من قبل البوت بالتأكيد معطله\n✓" 
else
redis:set(monster..'lave_me'..msg.chat_id_,true)  
...
🤖│[بوت تواصل](t.me/TUaSiLmonsterbot)
...
return '🚸*│*عدد سحہكآتگ ⇜ ❪ '..(redis:get(monster..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
if redis:get(monster..'welc'..msg.chat_id_) == 'on' then
...
local hash = monster..'user_names:'..msg.sender_user_id_
redis:set(hash,info)
end
...
------set cmd------
Black = msg.text 
mmd = redis:get(monster..'addcmd'..msg.chat_id_..msg.sender_user_id_)
if mmd then
redis:sadd(monster..'CmDlist:'..msg.chat_id_,msg.text)
redis:hset(monster..'CmD:'..msg.chat_id_,msg.text,mmd)
sendMsg(msg.chat_id_,msg.id_,'🙋🏻‍♂╿اهلا عزيزي \n📡╽تم تثبيت الامر الجديد\n✓')
redis:del(monster..'addcmd'..msg.chat_id_..msg.sender_user_id_)
end

if Black:match('تغير امر (.*)') then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local cmd = Black:match('تغير امر (.*)') 
redis:setex(monster..'addcmd'..msg.chat_id_..msg.sender_user_id_,120,cmd)
...
redis:hdel(monster..'CmD:'..msg.chat_id_,cmd)
redis:srem(monster..'CmDlist:'..msg.chat_id_,cmd)
sendMsg(msg.chat_id_,msg.id_,"🙋🏻‍♂╿اهلا عزيزي\nالامر >"..cmd.."\n📡╽ تم مسحه من قائمه الاوامر\n✓")
end
if Black == 'مسح قائمه الاوامر' or Black == 'مسح قائمه الاوامر' then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
redis:del(monster..'CmD:'..msg.chat_id_)
redis:del(monster..'CmDlist:'..msg.chat_id_)
sendMsg(msg.chat_id_,msg.id_,"♦️| اهلا عزيزي تم مسح قائمه الاوامر")
end
if Black == "قائمه الاوامر" then
if not msg.Kara then return "♦️*│*هذا الامر يخص {المنشئ الاساسي,المطور,المطور الاساسي} فقط  \n💥" end
local CmDlist = redis:smembers(monster..'CmDlist:'..msg.chat_id_)
local t = '♦️| قائمه الاوامر : \n'
for k,v in pairs(CmDlist) do
mmdi = redis:hget(monster..'CmD:'..msg.chat_id_,v)
t = t..k..") "..v.." > "..mmdi.."\n" 
end
if #CmDlist == 0 then
...
redis:set(monster..'welc'..msg.chat_id_,'on')
end
end
if Text == 'welcome off' or Text == 'تعطيل الترحيب' then
if redis:get(monster..'welc'..msg.chat_id_) == 'off' then
sendMsg(msg.chat_id_,msg.id_,'تم تعطيل الترحيب سابقا')
redis:set(monster..'welc'..msg.chat_id_,'off')
redis:del(monster..'welc'..msg.chat_id_,'on')
else
...
redis:set(monster..'joinchnl',true)
sendMsg(msg.chat_id_,msg.id_,'on')
end
if Text and redis:get(monster..'setchs') and msg.SudoUser then
redis:set(monster..'setch',Text)
sendMsg(msg.chat_id_,msg.id_,'تم تعين القناه علي \n'..Text)
redis:del(monster..'setchs')
end
if Text and (Text:match("^setch$")) and msg.SudoUser then
sendMsg(msg.chat_id_,msg.id_,'ارسل معرفك بدون @')
redis:setex(monster..'setchs',120,true)
end
...
function tophoto(kara,monster)   
if monster.content_.ID == "MessageSticker" then        
local bd = monster.content_.sticker_.sticker_.path_          
...
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(monster..':NameBot:')..[[] 🗽
...
local MSG_ID = (redis:get(monster.."USER_MSG_TWASEL"..FwdDate) or 1)
if msg.text then
...
if msg.text then 
redis:hset(monster..'replay:'..msg.chat_id_,klma,Flter_Markdown(msg.text))
...
if msg.text then
redis:hset(monster..'replay:all',klma,Flter_Markdown(msg.text))
...
elseif msg.voice then
redis:hset(monster..'replay_voice:group:',klma,voice_id)
redis:del(monster..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه بصمه صوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لسماع البصمه الاتيه ')
elseif msg.animation then
redis:hset(monster..'replay_animation:group:',klma,animation_id)
redis:del(monster..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه متحركه للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوره الاتيه ')
elseif msg.video then
redis:hset(monster..'replay_video:group:',klma,video_id)
redis:del(monster..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه فيديو للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵لاضهار الفيديو الاتي ')
elseif msg.audio then
redis:hset(monster..'replay_audio:group:',klma,audio_id)
redis:del(monster..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
return sendMsg(msg.chat_id_,msg.id_,'🗂╿تم اضافه للصوت للرد العام ✓\n🗂╽يمكنك ارسال ❴ ['..klma..'] ❵ لاضهار الصوت الاتي ')
elseif msg.sticker then
redis:hset(monster..'replay_sticker:group:',klma,sticker_id)
redis:del(monster..'addrd_all:'..msg.chat_id_..msg.sender_user_id_)
...
redis:set(monster.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(monster.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
...
if not redis:get(monster..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⚠¦ انت منشئ المجموعه ') 
return false
end
local Added_Me = redis:get(monster.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
if redis:get(monster..'Added:Me'..msg.chat_id_) then
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تفعيل امر منو ضافني\n✓")
redis:del(monster..'Added:Me'..msg.chat_id_)  
else
...
if not redis:get(monster..'Added:Me'..msg.chat_id_) then
redis:set(monster..'Added:Me'..msg.chat_id_,true)  
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تعطيل منو ضافني\n✓")
else
...
if redis:get(monster..'welcom:witting'..msg.sender_user_id_) then -- استقبال كليشه الترحيب
redis:del(monster..'welcom:witting'..msg.sender_user_id_) 
redis:set(monster..'welcome:msg'..msg.chat_id_,msg.text)
return sendMsg(msg.chat_id_,msg.id_,"📜*│* تم وضع الترحيب بنجاح كلاتي 👋\n✓" )
end
if redis:get(monster..'rulse:witting'..msg.sender_user_id_) then --- استقبال القوانين
redis:del(monster..'rulse:witting'..msg.sender_user_id_) 
...
if redis:get(monster..'name:witting'..msg.sender_user_id_) then --- استقبال الاسم
redis:del(monster..'name:witting'..msg.sender_user_id_) 
tdcli_function({ID= "ChangeChatTitle",chat_id_=msg.chat_id_,title_=msg.text},dl_cb,nil)
end
if redis:get(monster..'linkGroup'..msg.sender_user_id_,link) then --- استقبال الرابط
redis:del(monster..'linkGroup'..msg.sender_user_id_,link) 
redis:set(monster..'linkGroup'..msg.chat_id_,Flter_Markdown(msg.text)) 
return sendMsg(msg.chat_id_,msg.id_,'🖇│تم وضع الرابط الجديد بنجاح .. 🍂')
end
if redis:get(monster..'about:witting'..msg.sender_user_id_) then --- استقبال الوصف
redis:del(monster..'about:witting'..msg.sender_user_id_) 
...
if msg.forward_info and redis:get(monster..'fwd:'..msg.sender_user_id_) then
...
GetUserID(msg.sender_user_id_,function(arg,data)
redis:set(monster..'group:name'..msg.chat_id_,msg.content_.title_)
if data.username_ then UserName = "@"..data.username_ else UserName = "احد المشرفين" end
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(monster..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(monster..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
...
--------------------------------------------
if msg.adduser and redis:get(monster..'welcome:get'..msg.chat_id_) then
...
if not msg.forward_info and redis:get(monster..'lock_flood'..msg.chat_id_)  then
local msgs = (redis:get(monster..'user:'..msg.sender_user_id_..':msgs') or 0)
local NUM_MSG_monster = (redis:get(monster..'num_msg_monster'..msg.chat_id_) or 5)
if tonumber(msgs) > tonumber(NUM_MSG_monster) then 
GetUserID(msg.sender_user_id_,function(arg,datau)
Restrict(msg.chat_id_,msg.sender_user_id_,1)
redis:setex(monster..'sender:'..msg.sender_user_id_..':flood',30,true)
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_monster.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
...
return false
elseif msg.text:match("#[%a%d_]+") and redis:get(monster..'lock_tag'..msg.chat_id_) then
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.edited and redis:get(monster..'lock_edit'..msg.chat_id_) then -- قفل التعديل
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.document and redis:get(monster..'mute_document'..msg.chat_id_) then -- قفل الملفات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.sticker and redis:get(monster..'mute_sticker'..msg.chat_id_) then --قفل الملصقات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
elseif msg.contact and redis:get(monster..'mute_contact'..msg.chat_id_) then -- قفل الجهات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.location and redis:get(monster..'mute_location'..msg.chat_id_) then -- قفل الموقع
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.voice and redis:get(monster..'mute_voice'..msg.chat_id_) then -- قفل البصمات
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.game and redis:get(monster..'mute_game'..msg.chat_id_) then -- قفل الالعاب
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.audio and redis:get(monster..'mute_audio'..msg.chat_id_) then -- قفل الصوت
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
return false
elseif msg.replyMarkupInlineKeyboard and redis:get(monster..'mute_keyboard'..msg.chat_id_) then -- كيبورد
Del_msg(msg.chat_id_,msg.id_,function(arg,data)
...
if msg.text and redis:get(monster..'replay'..msg.chat_id_) then
...
local creators = redis:smembers(monster..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(monster..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
